...
- Keep capability status distinct from permission outcome in user-facing wording: an application preference is not proof that Android notification delivery, approximate location service, or inexact reminder scheduling is effective.

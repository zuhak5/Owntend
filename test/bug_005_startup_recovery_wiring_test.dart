...
void main() {
  test(
    'authenticated startup considers charged recovery before cached-ready shortcut',
    () {
      final source = File(
      ...
      expect(source.indexOf(recoveryCall), lessThan(source.indexOf(cachedReadyShortcut)));
      expect(
        source,

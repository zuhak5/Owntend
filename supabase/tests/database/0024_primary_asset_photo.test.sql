...
values ('00000000-0000-0000-0000-00000000000a', 'area-primary', 'Area Primary', 1);
insert into public.rooms (user_id, id, area_id, name, sort_order)
values ('00000000-0000-0000-0000-00000000000a', 'room-primary', 'area-primary', 'Room Primary', 1);
insert into public.assets (user_id, id, room_id, name, created_at, updated_at, revision)
values ('00000000-0000-0000-0000-00000000000a', '00000000-0000-0000-0000-000000000111', 'room-primary', 'Asset Primary', NOW(), NOW(), 1);
